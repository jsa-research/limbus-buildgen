...
run_ci()
{
    CI_SCRIPT_WWW_PATH=$ORIGINAL_CI_SCRIPT_WWW_PATH/node$BUILDGEN_NODE_VERSION-$BUILDGEN_TARGET_COMPILER
...
BUILDGEN_NODE_VERSION=5.9.0
BUILDGEN_TARGET_COMPILER=clang
run_ci

BUILDGEN_NODE_VERSION=4.4.0
BUILDGEN_TARGET_COMPILER=clang
run_ci
